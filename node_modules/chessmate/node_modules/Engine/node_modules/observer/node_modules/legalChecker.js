...
function isLegal(square, playerColor, moveFile, moveRank, observer) {
    ...
    if(color == 1)
        if(checkMate(color,observer) && squareKingB.isAttacked())
            return 'CheckMate';
    else
        if(checkMate(color,observer) && squareKingW.isAttacked())
            return 'CheckMate';

    if(staleMate(color,observer) && checkMate(color,observer))
        return 'StaleMate';
