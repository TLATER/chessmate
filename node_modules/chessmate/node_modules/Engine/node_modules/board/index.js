            ...
            switch (file) {
                ...
                case 1:
                    switch (rank) {
                        ...
                        case 8:
                            grid[file - 1][rank - 1] =
                                new Square(rank, file, Piece.rook(1));
                            break;

                        case 2:
                        case 7:
                            grid[file - 1][rank - 1] =
                                new Square(rank, file, Piece.knight(1));
                            break;

                        case 3:
                        case 6:
                            grid[file - 1][rank - 1] =
                                new Square(rank, file, Piece.bishop(1));
                            break;
                        case 4:
                            grid[file - 1][rank - 1] =
                                new Square(rank, file, Piece.queen(1));
                            break;
                        case 5:
                            grid[file - 1][rank - 1] =
                                new Square(rank, file, Piece.king(1));
                    }
                    break;
                // Fill with the white pawn row
                case 2:
                    grid[file - 1][rank - 1] =
                        new Square(rank, file, Piece.pawn(1));
                    break;

                // Fill with the black pawn row
                case 7:
                    grid[file - 1][rank - 1] =
                        new Square(rank, file, Piece.pawn(0));
                    break;
                ...
                case 8:
                    switch (rank) {
                        ...
                        case 8:
                            grid[file - 1][rank - 1] =
                                new Square(rank, file, Piece.rook(0));
                            break;

                        case 2:
                        case 7:
                            grid[file - 1][rank - 1] =
                                new Square(rank, file, Piece.knight(0));
                            break;

                        case 3:
                        case 6:
                            grid[file - 1][rank - 1] =
                                new Square(rank, file, Piece.bishop(0));
                            break;
                        case 4:
                            grid[file - 1][rank - 1] =
                                new Square(rank, file, Piece.queen(0));
                            break;
                        case 5:
                            grid[file - 1][rank - 1] =
                                new Square(rank, file, Piece.king(0));
                            break;
                    }
                    break;
                ...
                case 6:
                    grid[file - 1][rank - 1] =
                        new Square(rank, file, Piece.empty(), true);
                    break;

                default:
                    grid[file - 1][rank - 1] =
                        new Square(rank, file, Piece.empty());
            }
        }
