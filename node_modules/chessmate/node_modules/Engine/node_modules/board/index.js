...
var Board = function(Piece) {
            ...
            switch (rank) {
                ...
                case 0:
                    switch (file) {
                        ...
                        case 7:
                            grid[7 - rank][file] =
                                new Square(rank + 1, file + 1, Piece.rook(1));
                            break;

                        case 1:
                        case 6:
                            grid[7 - rank][file] =
                                new Square(rank + 1, file + 1, Piece.knight(1));
                            break;

                        case 2:
                        case 5:
                            grid[7 - rank][file] =
                                new Square(rank + 1, file + 1, Piece.bishop(1));
                            break;
                        case 3:
                            grid[7 - rank][file] =
                                new Square(rank + 1, file + 1, Piece.queen(1));
                            break;
                        case 4:
                            grid[7 - rank][file] =
                                new Square(rank + 1, file + 1, Piece.king(1));
                    }
                    break;
                // Fill with the white pawn row
                case 1:
                    grid[7 - rank][file] =
                        new Square(rank + 1, file + 1, Piece.pawn(1));
                    break;

                // Fill with the black pawn row
                case 6:
                    grid[7 - rank][file] =
                        new Square(rank + 1, file + 1, Piece.pawn(0));
                    break;
                ...
                case 7:
                    switch (file) {
                        ...
                        case 7:
                            grid[7 - rank][file] =
                                new Square(rank + 1, file + 1, Piece.rook(0));
                            break;

                        case 1:
                        case 6:
                            grid[7 - rank][file] =
                                new Square(rank + 1, file + 1, Piece.knight(0));
                            break;

                        case 2:
                        case 5:
                            grid[7 - rank][file] =
                                new Square(rank + 1, file + 1, Piece.bishop(0));
                            break;
                        case 3:
                            grid[7 - rank][file] =
                                new Square(rank + 1, file + 1, Piece.queen(0));
                            break;
                        case 4:
                            grid[7 - rank][file] =
                                new Square(rank + 1, file + 1, Piece.king(0));
                            break;
                    }
                    break;
                ...
                case 6:
                    grid[7 - rank][file] =
                        new Square(rank + 1, file + 1, Piece.empty(), true);
                    break;

                default:
                    grid[7 - rank][file] =
                        new Square(rank + 1, file + 1, Piece.empty());
            }
        }
    ...
    this.move = function() {
        console.log('Move method called');
    };
};
