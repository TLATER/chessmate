...
pieceMaker.prototype.rook = function(color, square) {
    var piece = new rook(color, this.piecesMade, square);
    this.piecesMade++;
    this.addPiece(piece);

    return piece;
};
pieceMaker.prototype.queen = function(color, square) {
    var piece = new queen(color, this.piecesMade, square);
    this.piecesMade++;
    this.addPiece(piece);

    return piece;
};
pieceMaker.prototype.pawn = function(color, square) {
    var piece = new pawn(color, this.piecesMade, square);
    this.piecesMade++;
    this.addPiece(piece);

    return piece;
};
pieceMaker.prototype.knight = function(color, square) {
    var piece = new knight(color, this.piecesMade, square);
    this.piecesMade++;
    this.addPiece(piece);

    return piece;
};
pieceMaker.prototype.king = function(color, square) {
    var piece = new king(color, this.piecesMade, square);
    this.piecesMade++;
    this.addPiece(piece);
    this.setKing(piece);
...
pieceMaker.prototype.bishop = function(color, square) {
    var piece = new bishop(color, this.piecesMade, square);
    this.piecesMade++;
    this.addPiece(piece);
