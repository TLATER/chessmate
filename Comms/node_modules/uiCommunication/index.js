...
//THIS RESPONSE MUST BE AN EVENT SOURCE, ASK TRISTAN IF YOU NEED HELP
// IMPLEMENTING THAT
...
// uiCommunication.prototype.registerMove = function(request, response){
//     var command = request.body;
//     var serverReturn = this.sendToServer(command);
//     response.send(serverReturn);
// };
...
module.exports = uiCommunication;